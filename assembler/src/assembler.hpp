...
class Assembler {
   ...
   private:
    inline static const OpcodeInfo opcodebase_info{
        {"and", {{"ftype", 1}, {"cmd", 0b0000}}},  {"eor", {{"ftype", 1}, {"cmd", 0b0001}}},
        {"sub", {{"ftype", 1}, {"cmd", 0b0010}}},  {"rsb", {{"ftype", 1}, {"cmd", 0b0011}}},
        {"add", {{"ftype", 1}, {"cmd", 0b0100}}},  {"adc", {{"ftype", 1}, {"cmd", 0b0101}}},
        {"sbc", {{"ftype", 1}, {"cmd", 0b0110}}},  {"rsc", {{"ftype", 1}, {"cmd", 0b0111}}},
        {"tst", {{"ftype", 2}, {"cmd", 0b1000}}},  {"teq", {{"ftype", 2}, {"cmd", 0b1001}}},
        {"cmp", {{"ftype", 2}, {"cmd", 0b1010}}},  {"cmn", {{"ftype", 2}, {"cmd", 0b1011}}},
        {"orr", {{"ftype", 1}, {"cmd", 0b1100}}},  {"mov", {{"ftype", 3}, {"cmd", 0b1101}}},
        {"lsl", {{"ftype", 4}, {"cmd", 0b1101}}},  {"lsr", {{"ftype", 4}, {"cmd", 0b1101}}},
        {"asr", {{"ftype", 4}, {"cmd", 0b1101}}},  {"rrx", {{"ftype", 4}, {"cmd", 0b1101}}},
        {"ror", {{"ftype", 4}, {"cmd", 0b1101}}},  {"bic", {{"ftype", 1}, {"cmd", 0b1110}}},
        {"mvn", {{"ftype", 1}, {"cmd", 0b1111}}},  {"mul", {{"ftype", 5}, {"cmd", 0b000}}},
        {"mla", {{"ftype", 6}, {"cmd", 0b001}}},   {"umull", {{"ftype", 6}, {"cmd", 0b100}}},
        {"umlal", {{"ftype", 6}, {"cmd", 0b101}}}, {"smull", {{"ftype", 6}, {"cmd", 0b110}}},
        {"smlal", {{"ftype", 6}, {"cmd", 0b111}}}, {"str", {{"ftype", 7}, {"L", 0b0}}},
        {"ldr", {{"ftype", 7}, {"L", 0b1}}},       {"b", {{"ftype", 8}, {"L", 0b0}}},
        {"bl", {{"ftype", 8}, {"L", 0b1}}}};
