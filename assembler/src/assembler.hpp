...
class Assembler {
   ...
   private:
    inline static const OpcodeInfo opcodebase_info{{"and", {{"ftype", 1}, {"cmd", 0b0000}}},
                                                   ...
                                                   {"mov", {{"ftype", 3}, {"cmd", 0b1101}, {"sh", 0b00}}},
                                                   {"lsl", {{"ftype", 4}, {"cmd", 0b1101}, {"sh", 0b00}}},
                                                   {"lsr", {{"ftype", 4}, {"cmd", 0b1101}, {"sh", 0b01}}},
                                                   {"asr", {{"ftype", 4}, {"cmd", 0b1101}, {"sh", 0b10}}},
                                                   {"rrx", {{"ftype", 4}, {"cmd", 0b1101}, {"sh", 0b11}}},
                                                   {"ror", {{"ftype", 4}, {"cmd", 0b1101}, {"sh", 0b11}}},
